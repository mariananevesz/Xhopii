...
<body>
    ...
    <p class="titulo-descobertas"><strong>FUNCIONÁRIOS</strong></p>

    <main>
        <section class="grade-produtos-visualizar">
    <?php while($funcionario = mysqli_fetch_assoc($funcionarios)) { ?>
        <?php $foto = empty($funcionario["foto"]) || !file_exists(__DIR__ . "/../" . $funcionario["foto"]) ? "../img/funcionario.png" : "../" . $funcionario["foto"]; ?>
